...
<body id="bg">
	...
	<div class="container">
		...
		<div class="leftsidebar_box">
			<a href="${pageContext.request.contextPath}/jsp/main.html" target="main"><div class="line">
			...
			<dl class="system_log">
				...
				<dd>
					<img class="coin11" src="../img/coin111.png" /><img class="coin22"
						src="../img/coin222.png" /><a class="cks" href="${pageContext.request.contextPath}/jsp/user.jsp"
